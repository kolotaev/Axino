...
class Event {
  static schema() {
    return {
      aggregateID: { type: 'String', present: true },
      sequenceNumber: { type: 'Integer', present: true },
      dateCreated: { type: 'Date', present: true },
    };
  }
  ...
  static fullSchema() {
    ...
    return _.reduceRight(schemas, (res, el) => _.assign(res, el), {});
  }
