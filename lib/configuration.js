const { DefaultEventsQueue, EventPublisher } = require('./event');
const { SnapshotDataEncoder } = require('./encoders');


const defaultEventsQueue = new DefaultEventsQueue();
const defaultEventPublisher = new EventPublisher(defaultEventsQueue);
