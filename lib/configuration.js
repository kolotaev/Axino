...
const { ArrayQueue, InMemoryMap } = require('./adt');
// ToDo - use AggregateRepository but without a circular dependency.
// const { AggregateRepository } = require('./aggregate');


const defaultEventPublisher = new EventPublisher(new ArrayQueue());
// const defaultAggregateRepository = new AggregateRepository(new InMemoryMap());
